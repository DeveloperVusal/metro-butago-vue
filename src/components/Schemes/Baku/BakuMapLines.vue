<template>
    <svg class="scheme-metro-view" viewBox="0 0 870 700" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M119.511 229.511L179.215 289.215" stroke="#91147C" stroke-width="6"/>
        <path d="M63.1282 173.128L116.078 226.078" stroke="#91147C" stroke-width="6"/>
        <circle cx="117" cy="227" r="5" fill="white"/>
        <circle cx="178" cy="288" r="5" fill="white"/>
        <circle cx="64" cy="174" r="5" fill="white"/>
        <path d="M211 422L290.5 422" stroke="#04AC5F" stroke-width="6"/>
        <path d="M290.5 422C307 422 312 418 319 410.5" stroke="#04AC5F" stroke-width="6"/>
        <path d="M288.5 178L369.5 178" stroke="#04AC5F" stroke-width="6"/>
        <path d="M193.5 178L286 178" stroke="#04AC5F" stroke-width="6"/>
        <path d="M131 226C131 175 128.5 178 188.5 178" stroke="#04AC5F" stroke-width="6"/>
        <path d="M131 290.5L131 335" stroke="#04AC5F" stroke-width="6"/>
        <path d="M137 403.5C143 422 178.5 422 204.5 422" stroke="#04AC5F" stroke-width="6"/>
        <path d="M135 398C131 383.5 131 366 131 340" stroke="#04AC5F" stroke-width="6"/>
        <path d="M131 229.5L131 287.5" stroke="#04AC5F" stroke-width="6"/>
        <path d="M458 271.5L518 211" stroke="#04AC5F" stroke-width="6"/>
        <path d="M520.795 208.307C536.5 194 545.5 180.5 570 178.5" stroke="#04AC5F" stroke-width="6"/>
        <path d="M636 224C615.5 204 593.5 179.5 573 178.5" stroke="#04AC5F" stroke-width="6"/>
        <path d="M321.5 407.5L396 333" stroke="#04AC5F" stroke-width="6"/>
        <path d="M397.532 331.5L456.032 273" stroke="#04AC5F" stroke-width="6"/>
        <path d="M448.372 280.644C458.836 269.491 469 258 468.5 220.5" stroke="#04AC5F" stroke-width="6"/>
        <path d="M668.257 256.5L637.879 226.121" stroke="#04AC5F" stroke-width="6"/>
        <path d="M696.257 284.5L671 259.243" stroke="#04AC5F" stroke-width="6"/>
        <path d="M726.257 314.5L698.258 286.5" stroke="#04AC5F" stroke-width="6"/>
        <path d="M755.879 343.879L728.5 316.5" stroke="#04AC5F" stroke-width="6"/>
        <circle cx="519" cy="210" r="5" fill="white"/>
        <circle cx="396" cy="333" r="5" fill="white"/>
        <circle cx="320" cy="409" r="5" fill="white"/>
        <circle cx="457" cy="272" r="5" fill="white"/>
        <circle cx="468" cy="218" r="5" fill="white"/>
        <circle cx="570" cy="179" r="5" fill="white"/>
        <circle cx="637" cy="225" r="5" fill="white"/>
        <circle cx="670" cy="258" r="5" fill="white"/>
        <circle cx="698" cy="286" r="5" fill="white"/>
        <circle cx="727" cy="315" r="5" fill="white"/>
        <circle cx="756" cy="344" r="5" fill="white"/>
        <circle cx="131" cy="339" r="5" fill="white"/>
        <circle cx="208" cy="422" r="5" fill="white"/>
        <circle cx="136" cy="402" r="5" fill="white"/>
        <circle cx="131" cy="288" r="5" fill="white"/>
        <circle cx="131" cy="227" r="5" fill="white"/>
        <circle cx="192" cy="178" r="5" fill="white"/>
        <circle cx="287" cy="178" r="5" fill="white"/>
        <circle cx="368" cy="178" r="5" fill="white"/>
        <line x1="187.861" y1="555.896" x2="245.861" y2="496.897" stroke="#EF1923" stroke-width="6"/>
        <path d="M248.894 493.863L326 416" stroke="#EF1923" stroke-width="6"/>
        <path d="M328.879 412.879L402 339.5" stroke="#EF1923" stroke-width="6"/>
        <path d="M404 337.5L464 278" stroke="#EF1923" stroke-width="6"/>
        <path d="M465 277L523.86 216.897" stroke="#EF1923" stroke-width="6"/>
        <path d="M466 276.5C469.5 270 479.5 250 478 220" stroke="#EF1923" stroke-width="6"/>
        <path d="M662.5 262.743L631.879 232.121" stroke="#EF1923" stroke-width="6"/>
        <path d="M629.5 230C605 205 585.165 188 573.5 188" stroke="#EF1923" stroke-width="6"/>
        <path d="M526.5 214.5C543.5 197.5 556 187.5 567.021 188.218" stroke="#EF1923" stroke-width="6"/>
        <path d="M690.5 290.743L665 265.243" stroke="#EF1923" stroke-width="6"/>
        <path d="M720.5 320.743L692 292.243" stroke="#EF1923" stroke-width="6"/>
        <path d="M750 350L722.379 322.379" stroke="#EF1923" stroke-width="6"/>
        <circle cx="525" cy="216" r="5" fill="white"/>
        <circle cx="403" cy="339" r="5" fill="white"/>
        <circle cx="464" cy="278" r="5" fill="white"/>
        <circle cx="478" cy="218" r="5" fill="white"/>
        <circle cx="186" cy="557" r="5" fill="white"/>
        <circle cx="248" cy="495" r="5" fill="white"/>
        <circle cx="327" cy="415" r="5" fill="white"/>
        <circle cx="570" cy="188" r="5" fill="white"/>
        <circle cx="630" cy="231" r="5" fill="white"/>
        <circle cx="663" cy="264" r="5" fill="white"/>
        <circle cx="691" cy="292" r="5" fill="white"/>
        <circle cx="720" cy="321" r="5" fill="white"/>
        <circle cx="749" cy="350" r="5" fill="white"/>
        <line x1="342" y1="428" x2="441" y2="428" stroke="#8AAC04" stroke-width="6"/>
        <circle cx="342" cy="428" r="5" fill="white"/>
        <circle cx="441" cy="428" r="5" fill="white"/>


        <g class="transfers">
            <rect x="112.4" y="222.4" width="23.2" height="9.2" rx="4.6" fill="white" stroke="#414141" stroke-width="0.8"/>
            <rect x="122" y="226" width="4" height="2" rx="1" fill="#D9D9D9"/>

            <rect x="456.565" y="265.484" width="18.2754" height="9.37337" rx="4.6" transform="rotate(40.5542 456.565 265.484)" fill="white" stroke="#414141" stroke-width="0.8"/>

            <rect x="319.526" y="402.451" width="38.3146" height="9.37337" rx="4.6" transform="rotate(40.5542 319.526 402.451)" fill="white" stroke="#414141" stroke-width="0.8"/>
            <rect width="8.23379" height="2" rx="0.999999" transform="matrix(0.754916 0.655821 -0.655631 0.755081 331.544 418.187)" fill="#D9D9D9"/>
        </g>

        <g class="view__station">
            <!-- Şah İsmayıl Xətai (lightgreen) -->
            <circle cx="441" cy="428" r="4" fill="#8AAC04"/>
        </g>
        <g class="view__station">
            <!-- Cəfər Cabbarlı (lightgreen) -->
            <circle cx="342" cy="428" r="4" fill="#8AAC04"/>
        </g>
        <g class="view__station">
            <!-- Həzi Aslanov (red) -->
            <circle cx="749" cy="350" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Həzi Aslanov (green) -->
            <circle cx="756" cy="344" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Əhmədli (red) -->
            <circle cx="720" cy="321" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Əhmədli (green) -->
            <circle cx="727" cy="315" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Xalqlar Dostluğu (red) -->
            <circle cx="691" cy="292" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Xalqlar Dostluğu (green) -->
            <circle cx="698" cy="286" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Neftçilər (red) -->
            <circle cx="663" cy="264" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Neftçilər (green) -->
            <circle cx="670" cy="258" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Qara Qarayev (red) -->
            <circle cx="630" cy="231" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Qara Qarayev (green) -->
            <circle cx="637" cy="225" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Koroğlu (red) -->
            <circle cx="570" cy="188" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Koroğlu (green) -->
            <circle cx="570" cy="179" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Ulduz (red) -->
            <circle cx="525" cy="216" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Ulduz (green) -->
            <circle cx="519" cy="210" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Bakmil (red) -->
            <circle cx="478" cy="218" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Bakmil (green) -->
            <circle cx="468" cy="218" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Nariman Narimanov (red) -->
            <circle cx="464" cy="278" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Nariman Narimanov (green) -->
            <circle cx="457" cy="272" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Gənclik (red) -->
            <circle cx="403" cy="339" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Gənclik (green) -->
            <circle cx="396" cy="333" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- 28 May (red) -->
            <circle cx="327" cy="415" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- 28 May (green) -->
            <circle cx="320" cy="409" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Sahil (red) -->
            <circle cx="248" cy="495" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- İçərişəhər (red) -->
            <circle cx="186" cy="557" r="4" fill="#EF1923"/>
        </g>
        <g class="view__station">
            <!-- Nizami (green) -->
            <circle cx="208" cy="422" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Elmlər Akademiyası (green) -->
            <circle cx="136" cy="402" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- İnşaatçılar (green) -->
            <circle cx="131" cy="339" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- 20 Yanvar (green) -->
            <circle cx="131" cy="288" r="4" fill="#04AC5F"/>
        </g>

        <g class="view__station">
            <!-- Memar Əcəmi (purple) -->
            <circle cx="117" cy="227" r="4" fill="#91147C"/>
        </g>
        <g class="view__station">
            <!-- Memar Əcəmi (green) -->
            <circle cx="131" cy="227" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Avtovağzal (purple) -->
            <circle cx="64" cy="174" r="4" fill="#91147C"/>
        </g>
        <g class="view__station">
            <!-- 8 Noyabr (purple) -->
            <circle cx="178" cy="288" r="4" fill="#91147C"/>
        </g>
        <g class="view__station">
            <!-- Nəsimi (green) -->
            <circle cx="192" cy="178" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Azadlıq prospekti (green) -->
            <circle cx="287" cy="178" r="4" fill="#04AC5F"/>
        </g>
        <g class="view__station">
            <!-- Dərnəgül (green) -->
            <circle cx="368" cy="178" r="4" fill="#04AC5F"/>
        </g>
    </svg>
</template>